...
public class Constants_MJ_NANCHANG extends GameConstants {
	...
	public static final int GAME_RULE_MJ_NC_BU_TUO_GUANG = 23; // 不托管
	public static final int GAME_RULE_MJ_NC_CHAO_SHI1 = 24; // 1分钟
	public static final int GAME_RULE_MJ_NC_CHAO_SHI3 = 25; // 3分钟
	public static final int GAME_RULE_MJ_NC_CHAO_SHI5 = 26; // 5分钟
